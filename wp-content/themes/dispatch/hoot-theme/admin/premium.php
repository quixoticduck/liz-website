...
$hoot_options_premium[] = array(
		'std' => sprintf( __("%1sUpgrade to Dispatch Premium%2sIf you've enjoyed using Dispatch, you're going to love Dispatch Premium. It's a robust upgrade to Dispatch that gives you useful features.", 'hoot'), '<h4 class="heading">', '</h4>' ) );

$hoot_options_premium[] = array(
		'name' => __('Complete Style Customization', 'hoot'),
		'desc' => __('Dispatch Premium lets you select different colors for different sections of your site.<hr>Assign different typography (fonts, text size, font color) to menu, topbar, content headings, sidebar, footer etc.', 'hoot'),
		'img' => 'premium-style.jpg',
		);

$hoot_options_premium[] = array(
		'name' => __('Unlimites Sliders, Unlimites Slides', 'hoot'),
		'desc' => __('Dispatch Premium allows you to create unlimited sliders with as many slides as you need.<hr>You can use these sliders on your Homepage widgetized template, or add them anywhere using shortcodes - like in your Posts, Sidebars or Footer.', 'hoot'),
...
$hoot_options_premium[] = array(
		...
		'desc' => __('Dispatch Premium gives you the option to display your post archives in 3 different layouts including a mosaic type layout similar to pinterest.', 'hoot'),
		'img' => 'premium-blogstyles.jpg',
		);

$hoot_options_premium[] = array(
		'name' => __('Custom Widgets', 'hoot'),
		'desc' => __('Custom widgets crafted and designed specifically for Dispatch Premium Theme to give you the flexibility of adding stylized content.', 'hoot'),
...
$hoot_options_premium[] = array(
		...
		'desc' => __('Dispatch Premium comes with many additional premium background patterns. You can always upload your own background image/pattern to match your site design.', 'hoot'),
		'img' => 'premium-backgrounds.jpg',
		);

$hoot_options_premium[] = array(
		'name' => __('Automatic Image Lightbox and WordPress Gallery', 'hoot'),
		'desc' => __('Automatically open image links on your site with the integrates lightbox in Dispatch Premium.<hr>Automatically convert standard WordPress galleries to beautiful lightbox gallery slider.', 'hoot'),
		'img' => 'premium-lightbox.jpg',
		);

$hoot_options_premium[] = array(
		'name' => __('Developers love {LESS}', 'hoot'),
		'desc' => __('CSS is passe. Developers love the modularity and ease of using LESS, which is why Dispatch Premium comes with properly organized LESS files for the main stylesheet. You can even turn on less.js during development to increase productivity.', 'hoot'),
...
$hoot_options_premium[] = array(
		'std' => sprintf( __("%1sContinued Updates%2sYou'll help support the continued development of Dispatch - ensuring it works with future versions of WordPress for years to come.", 'hoot'), '<h4 class="heading">', '</h4>' ) );

$hoot_options_premium[] = array(
		'name' => __('Premium Priority Support', 'hoot'),
		'desc' => __('Need help setting up Dispatch? Upgrading to Dispatch Premium gives you prioritized forum support. We have a growing support team ready to help you with your questions.', 'hoot'),
		'img' => 'premium-support.jpg',
		);

$hoot_options_premium[] = array(
		'std' => '<a class="button button-primary button-buy-premium" href="http://wphoot.com/themes/dispatch/" target="_blank">' . __('Buy Now', 'hoot') . '</a>', );
